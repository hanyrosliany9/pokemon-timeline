...
\restrict Sx4PbOcsz4cqnvdod0mMxEWEA42tiLSB1nolcR8gxeKdeq1R0dzbYLasVjdnsdb
...
--
-- Name: BatchStatus; Type: TYPE; Schema: public; Owner: pokemon_user
--
...
ALTER TYPE public."BatchStatus" OWNER TO pokemon_user;
...
--
-- Name: rendering_batches; Type: TABLE; Schema: public; Owner: pokemon_user
--

CREATE TABLE public.rendering_batches (
    id text NOT NULL,
    "projectId" text NOT NULL,
    "batchNumber" integer NOT NULL,
    "cardsCount" integer NOT NULL,
    "deadlineAt" timestamp(3) without time zone NOT NULL,
    "useLocalGpu" boolean DEFAULT true NOT NULL,
    "cloudGpusPlanned" integer NOT NULL,
    "cloudHoursPlanned" numeric(10,2) NOT NULL,
    "exchangeRateUsed" numeric(20,2) NOT NULL,
    "projectedCloudCostIDR" numeric(20,2) NOT NULL,
    "projectedElectricityCostIDR" numeric(20,2) NOT NULL,
    "projectedTotalCostIDR" numeric(20,2) NOT NULL,
    "projectedRevenueIDR" numeric(20,2) NOT NULL,
    "projectedProfitIDR" numeric(20,2) NOT NULL,
    "projectedMarginPercent" numeric(5,2) NOT NULL,
    "projectedCostPerCardIDR" numeric(20,2) NOT NULL,
    "projectedProfitPerCardIDR" numeric(20,2) NOT NULL,
    status public."BatchStatus" DEFAULT 'PENDING'::public."BatchStatus" NOT NULL,
...
ALTER TABLE public.rendering_batches OWNER TO pokemon_user;
...
db3ad628-a6df-48ff-9875-63c32cdecdbe	7e9171b8dad5bf41b79f462149ccb1168d7b9e8219e2016fac14a1faf03c9c64	2026-01-02 22:34:15.382144+00	20251228082236_init_prisma_7	\N	\N	2026-01-02 22:34:15.32708+00	1
8534f283-2046-402a-b2b2-e3109ee96ea9	fd5af0f967972778b6631d5d1e5bea449845efc1607996db56378e994ee4d297	2026-01-02 22:34:15.398278+00	20251228105212_add_income_model	\N	\N	2026-01-02 22:34:15.3834+00	1
db69f3c2-ffe6-4244-8f40-7908444fc304	3220cfed73596bd1c9cc4f85c9e9500f72077bc8b4e97c2090e39a883e426398	2026-01-02 22:34:15.41893+00	20251228110800_add_daily_progress_tracking	\N	\N	2026-01-02 22:34:15.399471+00	1
f6eead6b-6026-4cd5-b90b-1daba1ed5029	dfd67ed5f9555963f2985aab12e1e70fd04db0fe4de3e75e3e952d7005496bf5	2026-01-02 22:34:15.47486+00	20251228183645_add_dynamic_categories	\N	\N	2026-01-02 22:34:15.420939+00	1
...
COPY public.card_entries (id, "projectId", date, "cardsAdded", "cumulativeTotal", notes, "createdAt", "updatedAt", "batchId") FROM stdin;
\.
...
COPY public.card_projects (id, title, "goalTotal", progress, "createdAt", "updatedAt", "pricePerCardUSDT") FROM stdin;
5937999a-b8c9-45ac-989a-c63e0627bf35	Full Card Front and Back	30000	0	2025-12-28 17:16:33.129	2025-12-28 17:16:33.129	\N
58ce5997-df99-4548-b94d-a7859c047efc	3D Render Pokemon Card	30000	0	2025-12-28 16:54:58.516	2026-01-02 23:43:31.174	0.13000000
\.
...
adf24b2c-5815-4914-bdd1-eac5819e4a95	USDT	IDR	16725.82000000	coingecko	2026-01-03 01:10:00.867	2026-01-03 00:10:00.87
\.
...
68e48f51-b7f2-4dce-a93a-bbdc83bf3234	USDT	IDR	16695.27000000	coingecko	2026-01-02 22:35:00.637	2026-01-02 22:35:00.639
cdb89c58-4743-4465-8c7c-621dc5ba4c5b	USDT	IDR	16695.27000000	coingecko	2026-01-02 22:40:00.673	2026-01-02 22:40:00.675
5f295530-af28-460f-b2e0-0b3a62f1662d	USDT	IDR	16695.27000000	coingecko	2026-01-02 22:45:00.828	2026-01-02 22:45:00.829
ade1cd01-828f-4592-8de5-216a94582eda	USDT	IDR	16695.27000000	coingecko	2026-01-02 22:55:00.715	2026-01-02 22:55:00.717
29e0310b-a958-4942-b4bb-563d8d8636f6	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:00:00.633	2026-01-02 23:00:00.635
d5ae4ffd-b9c2-441a-82f9-f009a4685708	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:05:00.643	2026-01-02 23:05:00.645
3ecdd776-83b6-4ac7-9d7d-ee5f88dbf05a	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:10:01.072	2026-01-02 23:10:01.074
979a73b3-a414-4d0b-a43b-56a2ad7142dc	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:15:00.696	2026-01-02 23:15:00.697
b2bba7cd-7bee-4596-9ea8-6d92d9e75059	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:20:01.04	2026-01-02 23:20:01.041
ee116686-5a5b-41a9-ab6f-d4edaaab04ce	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:25:00.962	2026-01-02 23:25:00.963
7774cea4-afa3-43d5-979c-1c61e7bd2783	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:30:00.874	2026-01-02 23:30:00.875
8a4cffff-f6cd-402d-bad8-f64e848df0ab	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:35:00.783	2026-01-02 23:35:00.784
d8a4c270-c497-466f-8727-30dd28ba88d3	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:40:01.253	2026-01-02 23:40:01.254
860e0f97-3d14-4c94-b7d0-1ac8e6911ba4	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:45:01.366	2026-01-02 23:45:01.367
b540f617-1322-4a53-9aa8-0f9fd16656a8	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:50:00.676	2026-01-02 23:50:00.677
07af0feb-2e89-4d0a-87de-046d996e17f3	USDT	IDR	16695.27000000	coingecko	2026-01-02 23:55:00.817	2026-01-02 23:55:00.818
e9abcbe2-a9b0-473b-8fc9-0df2cd54a0be	USDT	IDR	16695.27000000	coingecko	2026-01-03 00:00:03.188	2026-01-03 00:00:03.189
1319eb91-31de-4aee-81d2-666a4aaf4177	USDT	IDR	16725.82000000	coingecko	2026-01-03 00:05:01.185	2026-01-03 00:05:01.186
1e6f0370-aaba-473f-b264-aef444e1d6f4	USDT	IDR	16725.82000000	coingecko	2026-01-03 00:10:00.886	2026-01-03 00:10:00.887
\.
...
COPY public.expenses (id, description, amount, currency, "amountUSDT", "amountIDR", "exchangeRateId", "expenseDate", notes, "receiptUrl", tags, "createdAt", "updatedAt", "categoryId", "projectId", "batchId") FROM stdin;
388e6984-6c3f-4609-ad55-05074b45fe6f	Reimburse Julius (Transport, 3D Asset, Render)	858000.00000000	IDR	51.16215003	858000.00	\N	2025-12-28 00:00:00	\N	\N	{}	2025-12-28 17:15:15.474	2025-12-28 17:15:15.474	847358ba-c48e-4401-81a1-5f04f1adb5e0	\N	\N
211e9c40-9bd7-4697-9207-6badbbaa0bc4	Reimburse Kelby (Ringgit, Transport, Tools, Konsumsi)	6215000.00000000	IDR	370.59762519	6215000.00	\N	2025-12-28 00:00:00	\N	\N	{}	2025-12-28 17:16:07.879	2025-12-28 17:16:07.879	2ae5234a-b20b-493f-bc67-8dccebb831a3	\N	\N
8e954a4a-73a9-4f38-b64c-3293a413ede0	Projected Expenses	10000000.00000000	IDR	598.97204418	10000000.00	\N	2026-01-03 00:00:00	\N	\N	{}	2026-01-03 00:00:27.638	2026-01-03 00:00:27.638	16131f19-d049-4e4a-8190-e9aab7d9a2f8	\N	\N
\.
...
--
-- Data for Name: rendering_batches; Type: TABLE DATA; Schema: public; Owner: pokemon_user
--

COPY public.rendering_batches (id, "projectId", "batchNumber", "cardsCount", "deadlineAt", "useLocalGpu", "cloudGpusPlanned", "cloudHoursPlanned", "exchangeRateUsed", "projectedCloudCostIDR", "projectedElectricityCostIDR", "projectedTotalCostIDR", "projectedRevenueIDR", "projectedProfitIDR", "projectedMarginPercent", "projectedCostPerCardIDR", "projectedProfitPerCardIDR", status, "startedAt", "completedAt", notes, "createdAt", "updatedAt") FROM stdin;
\.
...
--
-- Name: rendering_batches rendering_batches_pkey; Type: CONSTRAINT; Schema: public; Owner: pokemon_user
--

ALTER TABLE ONLY public.rendering_batches
    ADD CONSTRAINT rendering_batches_pkey PRIMARY KEY (id);


--
-- Name: card_entries_batchId_date_key; Type: INDEX; Schema: public; Owner: pokemon_user
--

CREATE UNIQUE INDEX "card_entries_batchId_date_key" ON public.card_entries USING btree ("batchId", date);


--
-- Name: card_entries_batchId_idx; Type: INDEX; Schema: public; Owner: pokemon_user
--

CREATE INDEX "card_entries_batchId_idx" ON public.card_entries USING btree ("batchId");
...
--
-- Name: expenses_batchId_idx; Type: INDEX; Schema: public; Owner: pokemon_user
--

CREATE INDEX "expenses_batchId_idx" ON public.expenses USING btree ("batchId");
...
--
-- Name: rendering_batches_projectId_batchNumber_key; Type: INDEX; Schema: public; Owner: pokemon_user
--

CREATE UNIQUE INDEX "rendering_batches_projectId_batchNumber_key" ON public.rendering_batches USING btree ("projectId", "batchNumber");


--
-- Name: rendering_batches_projectId_idx; Type: INDEX; Schema: public; Owner: pokemon_user
--

CREATE INDEX "rendering_batches_projectId_idx" ON public.rendering_batches USING btree ("projectId");


--
-- Name: rendering_batches_status_idx; Type: INDEX; Schema: public; Owner: pokemon_user
--

CREATE INDEX rendering_batches_status_idx ON public.rendering_batches USING btree (status);


--
-- Name: card_entries card_entries_batchId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: pokemon_user
--

ALTER TABLE ONLY public.card_entries
    ADD CONSTRAINT "card_entries_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES public.rendering_batches(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: expenses expenses_batchId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: pokemon_user
--

ALTER TABLE ONLY public.expenses
    ADD CONSTRAINT "expenses_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES public.rendering_batches(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: rendering_batches rendering_batches_projectId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: pokemon_user
--

ALTER TABLE ONLY public.rendering_batches
    ADD CONSTRAINT "rendering_batches_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES public.card_projects(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict Sx4PbOcsz4cqnvdod0mMxEWEA42tiLSB1nolcR8gxeKdeq1R0dzbYLasVjdnsdb
